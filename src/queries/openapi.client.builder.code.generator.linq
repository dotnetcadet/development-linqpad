...
async Task Main()
{
	...
	{
		Directory = @"C:\source\repos\doubleline-clients\txedx\txedx-brainstorming\edfi-graphql-poc\src\TxEdX.EdFi",
	...
	{
		RequestUri = new Uri("https://api.ed-fi.org/v5.3/api/metadata/data/v3/resources/swagger.json"),
