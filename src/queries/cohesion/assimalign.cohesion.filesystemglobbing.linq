...
#region Assimalign.Cohesion.FileSystemGlobbing(net8.0)
namespace Assimalign.Cohesion.FileSystemGlobbing
{
	#region \
	public class FileMatcherContext
	{
	    private readonly IFileSystemDirectoryInfo _root;
	    ...
	    public FileMatcherContext(
	        ...
	        IFileSystemDirectoryInfo container,
	    ...
	    private void Match(IFileSystemDirectoryInfo directory, string parentRelativePath)
	    {
	        ...
	        var subDirectories = new List<IFileSystemDirectoryInfo>();
	        foreach (var fileInfo in entities)
	        {
	            if (fileInfo is IFileSystemDirectoryInfo directoryInfo)
	            {
	    ...
	    private void PushDirectory(IFileSystemDirectoryInfo directory)
	    {
	        foreach (IFilePatternContext context in _includePatternContexts)
	        {
	...
	public interface IFileSystemInfo
	{
	    ...
	    IFileSystemDirectoryInfo ParentDirectory { get; }
	}
	#endregion
	#region \Extensions
	   ...
	   : FilePatternContext<FilePatternContextLinear.FrameData>
	{
	    ...
	    public override FilePatternTestResult Test(IFileSystemInfo file)
	    {
	        if (IsStackEmpty())
	        {
	    ...
	    public override void PushDirectory(IFileSystemDirectoryInfo directory)
	    {
	...
	public abstract class FilePatternContextRagged : FilePatternContext<FilePatternContextRagged.FrameData>
	{
	    ...
	    public sealed override void PushDirectory(IFileSystemDirectoryInfo directory)
	    {
	        // copy the current frame
	        FrameData frame = Frame;
	        if (IsStackEmpty())
