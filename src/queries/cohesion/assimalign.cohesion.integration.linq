...
#load ".\assimalign.cohesion.configurationstore"
#load ".\assimalign.cohesion.eventhub"
#load ".\assimalign.cohesion.iothub"
#load ".\assimalign.cohesion.messagehub"
#load ".\assimalign.cohesion.notificationhub"
...
#region Assimalign.Cohesion.Integration(net8.0)
namespace Assimalign.Cohesion.Integration
{
	#region \obj\Debug\net8.0
	#endregion
}
