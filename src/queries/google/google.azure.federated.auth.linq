...
async Task Main()
{
	var serviceAccount = "sa-notification-service-test@mjnd-iac-7ca2.iam.gserviceaccount.com";
	var clientAssertionCredentialOptions = new ClientAssertionCredentialOptions() 
	{
		ClientId =  "d99efcc3-2aef-4c32-b5b3-32c283718be6",
		TenantId = "434fb384-7364-4ee6-9461-3b60b543b606",
	...
	await client.Users["c.crawford@wearedoubleline.com"]
		.SendMail
		.PostAsync(new Microsoft.Graph.Users.Item.SendMail.SendMailPostRequestBody()
		{
			Message = new()
			{
				...
				Sender = new  Recipient
				{
					...
					{
						Address = "c.crawford@wearedoubleline.com"
					}
				},
				Body = new ItemBody
				{
