...
void Main()
{
	Func<string, Either<string, int>> func = (value) =>
	{
		if (Value is null)
		{
			return 0;
...
{
	public static Func<None> ToFuncOfNone (this Action action) => () =>
	{
		action();
		return new None();
	};

	public static Func<Task<None>> ToFuncOfNone (this Func<Task> a) => async () =>
	{
...
#endregion Either<T1, T2, T3, T4, T5>